...
/* type */
.primary {
  @apply bg-blue-700 text-white hover:bg-blue-800 focus:ring-blue-300
}
.alternative {
  @apply bg-white border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-gray-200
}
.dark {
